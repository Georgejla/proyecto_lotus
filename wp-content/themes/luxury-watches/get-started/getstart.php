 ...
 * @since 1.0.0
 */
function luxury_watches_admin_notice_site_demo() {
    ?>
    <div class="notice notice-success is-dismissible " style="display: flex; padding: 10px;">
        <p><?php echo esc_html( 'Initiate your theme exploration by clicking on the "Getting Started" Button.', 'luxury-watches' ); ?></p>
        <a style="margin-left: 30px;" class=" button button-primary " href="<?php echo esc_url( admin_url( 'themes.php?page=luxury-watches' )); ?>" ><?php esc_html_e( 'Getting Started', 'luxury-watches' ) ?></a>
    </div>
    <?php
}
add_action( 'admin_notices', 'luxury_watches_admin_notice_site_demo' );
