...
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"accent","textColor":"primary","style":{"typography":{"letterSpacing":"1.5px"},"border":{"radius":"15px"}},"className":"is-style-outline","fontSize":"medium","fontFamily":"barlowcondensed"} -->
<div class="wp-block-button has-custom-font-size is-style-outline has-barlowcondensed-font-family has-medium-font-size" style="letter-spacing:1.5px"><a class="wp-block-button__link has-primary-color has-accent-background-color has-text-color has-background wp-element-button" href="#" style="border-radius:15px"><strong>'. esc_html('SHOP COLLECTION','luxury-watches') .'</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
