...
<div class="wp-block-group has-accent-background-color has-background"><!-- wp:paragraph {"align":"center","style":{"typography":{"letterSpacing":"2px"}},"fontSize":"medium","fontFamily":"barlowcondensed"} -->
<p class="has-text-align-center has-barlowcondensed-font-family has-medium-font-size" style="letter-spacing:2px"><strong>'. esc_html('FREE HEAVY SHIPPING ON ORDER OVER $200','luxury-watches') .'</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"mainheader ","layout":{"type":"constrained","contentSize":"70%"}} -->
<div class="wp-block-group mainheader"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center is-vertically-aligned-top menu-box" style="flex-basis:40%"><!-- wp:navigation {"layout":{"type":"flex","justifyContent":"left"},"fontFamily":"barlowcondensed"} -->
